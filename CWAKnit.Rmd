...
ggplot() +
  geom_point(data=Prob_CAD,aes(CAD_Weight,Prob_3), col = "black") +
  geom_point(data=Prob_CAD,aes(CAD_Weight,Prob_5), col = "blue") +
  geom_point(data=Prob_CAD,aes(CAD_Weight,Prob_8), col = "red")
