...
P9 = pnorm(q=1.1*data_test$CAD_Weight,mean = model3$mu,sd = model3$sigma,lower.tail = FALSE)

y=cbind(ProbabilitiesTask9,data_test)

ggplot() +
  geom_point(data=y,aes(CAD_Weight,P9))
